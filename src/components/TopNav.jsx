      ...
      <div className="flex items-center">
        ...
        <h1 className="flex items-center ml-4 font-light text-sm">
          <svg
            ...
            className="mr-1"
          >
            <g clip-path="url(#clip0_104395_2522)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
      ...
      <div>
        <form>
          <input
            ...
            className="p-2 bg-gray-100 rounded-md font-light w-80"
          ></input>
        </form>
      </div>
      <div className="flex items-center">
        ...
        <button className="p-1 rounded-full shadow-sm bg-gray-200 ml-3">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_104395_2537)">
