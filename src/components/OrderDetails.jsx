...
function OrderDetails() {
  return (
    <div className="mt-3">
      <div>
        <div className="flex bg-[#F2F2F2] px-3 py-4 rounded-md">
          <h1 className="w-1/4 mr-10 text-sm font-medium">Order ID</h1>
          <h1 className="w-1/4 mr-10 flex items-center text-sm font-medium">
            Order Date{" "}
            <svg
          ...
          <h1 className="w-1/4 flex justify-end mr-10 text-sm font-medium">
            Order Amount
          </h1>
          <h1 className="w-1/4 flex justify-end items-center text-sm font-medium">
            Transaction fees{" "}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
          ...
          return (
            <div>
              <div className="flex  px-3 py-3 rounded-md">
                <h1 className="w-1/4 mr-10 text-sm font-medium text-[#146EB4]">
                  {Data.id}
                </h1>
                <h1 className="w-1/4 mr-10 flex items-center text-sm font-medium">
                {Data.date}
              ...
              <hr className="border-1.5 border-gray-300 my-1" />
            </div>
          );
        })}
      </div>
