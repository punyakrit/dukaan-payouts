        ...
        <div className="flex justify-between">
          <div>
            <input
              ...
              className="p-2 text-gray-400 rounded-md border-[#D9D9D9]  border-2 px-4 py-2"
            ></input>
          </div>
          <div className="flex">
            <button className="text-md px-3 py-2 border-2 rounded-md flex items-center">
              Sort{" "}
              <svg
            ...
            <button className="text-md p-2 border-2 ml-3 rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
